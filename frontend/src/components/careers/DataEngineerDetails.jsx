        ...
        <div className="relative w-full h-[300px] md:h-[350px] flex items-center justify-center text-center text-white overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-300">
              ...
              <span className="mx-2">›</span> Data Engineer
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-[2fr_1fr] gap-10">
            ...
            >
              ...
              <p className="text-gray-600 text-lg leading-9">
                Evaluate, understand and interpret data received from various sources. 
                Write specifications to capture required information from data assets. 
                Build and maintain scalable data pipelines, prototypes, algorithms and 
                data assets. Analyse complex raw data to improve data models and generate reports. Eva...
              </p>
...
export default DataEngineerDetails
