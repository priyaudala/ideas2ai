          ...
          <div className="grid lg:grid-cols-[2fr_1fr] gap-10">
            ...
            >
              ...
              <p className="text-gray-600 text-lg leading-9">
                ...
                Developer to join our growing team at Eagle Eye Tech.
                The ideal candidate should have experience in developing
                responsive web applications using modern technologies and
                should be eager to learn and innovate.
              </p>

              <p className="text-gray-600 text-lg leading-9 mt-6">
                You will work with a creative and collaborative team to
                build scalable applications using React.js, Node.js,
